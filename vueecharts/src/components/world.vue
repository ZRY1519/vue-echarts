<template>
    <div class="world">
        <div class="title">
            <div @click="line">折线科技图</div>
            <div @click="columnar">柱状科技图</div>
            <div @click="rose">玫瑰科技图</div>
        </div>
        <div id="myChart"></div>
    </div>
</template>
    ...
    export default {
        ...
        mounted() {
            ...
            */
            ...
            let myChart = this.$echarts.init(document.getElementById('myChart'))//柱状图
            myChart.setOption({
        ...
        methods:{
            ...
            //点击柱状科技图
            columnar(){
                this.$router.push({path:'/columnar'})
            },
            //点击玫瑰科技图
        　　rose(){
                this.$router.push({path:'/rose'})
            }
        }
    }
</script>
